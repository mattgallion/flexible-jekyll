...
![](/assets/img/20200908-Fire/FireError.jpeg){ width=50% }
...
![](/assets/img/20200908-Fire/FireSerial.png){ width=50% }
...
![](/assets/img/20200908-Fire/AWSerial.png){ width=50% }

## Fire TV BLE Attributes and Serial Number
If you connect to a Fire TV with the GATT analyzer, you’ll see that Amazon shares a few more details than Apple. You can find hardware revision, firmware version, and of course, the serial number. ![](/assets/img/20200908-Fire/FireSerialHex.jpeg){ width=50% }
